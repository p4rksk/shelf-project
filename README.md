...
| 이름 | 사진 | 역할 |  
|:--:|:--:|:---------------:|
| 박선규   |<img src="https://github.com/p4rksk/miniproject-jobala-v2-ssr/assets/153582360/cf8fd9c6-50d9-40b5-9914-09527344bf92" width="100">  | ERD설계, 프로젝트 초기 세팅 초기 더미 작업 <br/> 관리자:책 목록보기, 상세보기, 수정, 삭제, <br/>사용자: 회원가입,<br/> 메인(책히스토리,(일간,주간,누적 <br/>베스트셀러)), <br/>내서재(책목록, 위시리스트, 리뷰 관리), <br/> 랭크(카데고리별 베스트셀러)<br/> 시연영상 촬영, PPT준비, 발표|
---
